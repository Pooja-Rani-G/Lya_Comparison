...
log_dir = "/user1/poojarani/Lya_Comparison/ramses_analysis/lev{lev:03}_len{length}/Gas_grid/logs/".format(
    lev=lev, length=lengths)
...
for output_number in output_numbers:
    ...
    job_script_name = f"gasgrid_{output_number[-2:]}_{lev}_{lengths}.pbs"
