...
base_command = ("/usr/bin/time -v /apps/Python/anaconda3/bin/python "
                "/user1/poojarani/Lya_Comparison/ramses_codes/DM_grid.py -i /user1/poojarani/Lya_Comparison/ramses_data/lev{lev:03}_len{length}/{output_folder}/ -lm {lev} "
                "-o /user1/poojarani/Lya_Comparison/ramses_analysis/lev{lev:03}_len{length}/DM_grid/")
...
job_script_dir = "/user1/poojarani/Lya_Comparison/ramses_analysis/lev{lev:03}_len{length}/DM_grid/job_scripts/".format(
    lev=lev, length=lengths)
os.makedirs(job_script_dir, exist_ok=True)

# Define the log directory for .o and .e files
log_dir = "/user1/poojarani/Lya_Comparison/ramses_analysis/lev{lev:03}_len{length}/DM_grid/logs/".format(
    lev=lev, length=lengths)
...
for output_number in output_numbers:
    ...
    job_script_name = f"dmgrid_{output_number[-2:]}_{lev}_{lengths}.pbs"
