...
log_dir = "/user1/poojarani/Lya_Comparison/ramses_analysis/lev{lev:03}_len{length}/PS_gas/logs/".format(
    lev=lev, length=lengths)
...
for output_number in output_numbers:
    ...
    job_script_name = f"PSg_{output_number}_{lev}_{lengths}.pbs"
