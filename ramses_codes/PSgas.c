//Compile as gcc PSgas.c -std=gnu99 -I/mnt/exports/data/install/fftw-3.3.8/include -L/mnt/exports/data/install/fftw-3.3.8/lib -lfftw3 -I/apps/gsl-2.7.1/include -L/apps/gsl-2.7.1/lib -lgsl -lgslcblas -lm -o psgas
//Run as ./psgas {lev} {length} {output_forlder}
...
void myps(int nbox, float **grid, float box_size, int level, int outs)
{
  ...
  // ----------------------
   ...
   char save_path[MAX_PATH_LENGTH];
    snprintf(save_path, MAX_PATH_LENGTH, "/user1/poojarani/Lya_Comparison/ramses_analysis/lev%03d_len%d/PS_gas/psgas_%03d.txt", level, (int)box_size, outs);
...
int main(int argc, char **argv)
{
   ...
   char file_path[MAX_PATH_LENGTH];
    snprintf(file_path, MAX_PATH_LENGTH, "/user1/poojarani/Lya_Comparison/ramses_analysis/lev%03d_len%d/Gas_grid/gas_grid_%03d.bin", lev, (int)boxsize, output);
