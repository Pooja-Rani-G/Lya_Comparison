...
!=================================================================================================
  !!Shikhar: Planck 2018 results; VI. Cosmological parameters
  real(kind=8),parameter :: Omega_M = 0.315
  real(kind=8),parameter :: Omega_L = 0.685
  real(kind=8),parameter :: Omega_b = 0.045
  real(kind=8),parameter :: H_0     = 67.4  ! [km/s/Mpc]
!=================================================================================================
