program PhotonsFromStars
  ...
  print*,'minmax pos (code units) =',minval(star_pos),maxval(star_pos)
  print*,'minmax vel (cm/s) =',minval(star_vel),maxval(star_vel)
  print*,'minmax mass (g) =',minval(star_mass),maxval(star_mass)
  print*,'minmax age (Myr) =',minval(star_age),maxval(star_age)
  print*,'minmax met (dimensionless) =',minval(star_met),maxval(star_met)
  print*  
