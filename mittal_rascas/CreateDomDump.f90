...
!==============================================================================
!Shikhar: Writing the level number and redshift of RAMSES output on which you will run RT.
!Read only the levelmin because that is what I will use to construct my 3D array for P_\alpha.
  lev = int(get_param_real(repository,snapnum,'levelmin'))
  aexp = (get_param_real(repository,snapnum,'aexp'))
  str=trim(DomDumpDir)//trim('raminfo.txt')
  
  open(unit=20, file=str, form='formatted', action='write')
  write(20,*) lev
  write(20,*) 1/aexp
  close(20)
!==============================================================================
